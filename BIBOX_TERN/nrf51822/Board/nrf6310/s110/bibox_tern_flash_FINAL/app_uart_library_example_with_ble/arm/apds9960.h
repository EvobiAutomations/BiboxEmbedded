...
#define DEFAULT_POFFSET_UR      0x0A    // 10 offset
#define DEFAULT_POFFSET_DL      0x0A       // 10 offset      
...
/**************************************************************
***************** Set address pointer for i2c operation *******
**************************************************************/
...
/**************************************************************
***************** Enable Ambient Light interrupt **************
**************************************************************/
...
/**************************************************************
****************** read the ambient light register ************
**************************************************************/
...
/**************************************************************
***************** Check communication of ic, return true if 
communication is ok ******************************************/
...
/*************************************************************
***************** Returns true if the valid gesture datas are
available ***************************************************/
...
/*************************************************************
***************** Read the gesture datas of the four ir sensors
*************************************************************/
...
/*************************************************************
****************** Process collected gesture datas ***********
*************************************************************/

bool APDS9960_ProcessGestureData(unsigned char*);



/*************************************************************
****************** Read proximity value            ***********
The values are stored in 16bit format, the function will copy 
the values in the following order clear,red,green and blue
*************************************************************/

bool APDS9960_ReadProximity(unsigned char*);
...
bool APDS9960_ReadGesture(unsigned char* );
