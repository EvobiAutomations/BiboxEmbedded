...
void Winbond_SPI_Initial(void)
{
	...
	nrf_gpio_cfg_input(2,NRF_GPIO_PIN_PULLUP);
		...
		((NRF_SPI_Type *) 0x40003000UL)->PSELMISO=2;
		((NRF_SPI_Type *) 0x40003000UL)->PSELMOSI=1;
		((NRF_SPI_Type *) 0x40003000UL)->PSELSCK=0;
		
		((NRF_SPI_Type *) 0x40003000UL)->CONFIG=0;
		((NRF_SPI_Type *) 0x40003000UL)->FREQUENCY=0x80000000;
		((NRF_SPI_Type *) 0x40003000UL)->ENABLE=1;
		nrf_gpio_pin_set(3);
#line 36 "..\\winbond_flash.c"
...
{
	unsigned char val;
	((NRF_SPI_Type *) 0x40003000UL)->TXD=data;
  nrf_delay_us(1);
	
	val=((NRF_SPI_Type *) 0x40003000UL)->RXD;
