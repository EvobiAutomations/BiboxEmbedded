...
void ST7735_SPI_Initial(void)
{
		...
		((NRF_SPI_Type *) 0x40004000UL)->ENABLE=1;
		((NRF_SPI_Type *) 0x40004000UL)->PSELSCK=4;
		((NRF_SPI_Type *) 0x40004000UL)->PSELMOSI=5;
		((NRF_SPI_Type *) 0x40004000UL)->PSELMISO=0xffffffff;		
		((NRF_SPI_Type *) 0x40004000UL)->FREQUENCY=0x80000000;
		((NRF_SPI_Type *) 0x40004000UL)->CONFIG=0x00000000;
...
{
	((NRF_SPI_Type *) 0x40004000UL)->TXD=num;
  nrf_delay_us(1);
	
	((NRF_SPI_Type *) 0x40004000UL)->EVENTS_READY=0;
...
void ST7735_PutChar1X(unsigned char ch,uint16_t color,uint16_t background)
{
	unsigned char val;
...
void ST7735_PutChar2X(unsigned char ch,uint16_t color,uint16_t background)
{
	unsigned char val;
	const unsigned char *ptr;
...
void ST7735_PutChar3X(unsigned char ch,uint16_t color,uint16_t background)
{
	unsigned char val;
	const unsigned char *ptr;
  ...
  void ST7735_Put_String(char *str,uint16_t color,uint16_t background)
{                                   
        while(*str)ST7735_PutChar1X(*str++,color,background);
}


  void ST7735_Put_String2X(char *str,uint16_t color,uint16_t background)
{                                   
        while(*str)ST7735_PutChar2X(*str++,color,background);
}


  void ST7735_Put_String3X(char *str,uint16_t color,uint16_t background)
{                                   
